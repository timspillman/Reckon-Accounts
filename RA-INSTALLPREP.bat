...
ECHO 9.Reckon Accounts 2022
ECHO. 

CHOICE /C 1234567890 /M "Select a Version:"

IF ERRORLEVEL 0 GOTO 2022
...
set YEAR=2022
set PORT=10185
set FOLDER=Reckon Accounts 2022
set DATAUSER=QBDataServiceUser31
goto CheckOS
